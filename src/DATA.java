public class DATA {
    ...
    static String[] EXERCISE_DESCRIPTIONS = {
    ...
    static int[] EXERCISE_DURATIONS = {
            30, 90, 45, 60, 90, 60
    };
    static Position[] EXERCISE_POSITIONS = {
           Position.FLOOR, Position.FLOOR, Position.STANDING, Position.FLOOR, Position.STANDING, Position.STANDING
    };
